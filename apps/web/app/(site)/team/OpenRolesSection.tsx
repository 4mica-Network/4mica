...
export default function OpenRolesSection() {
  return (
    <section className="relative isolate mt-24 w-full overflow-hidden rounded-xl px-2 py-24 lg:px-0">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 -z-10 w-48 bg-linear-to-r from-surface-deep to-transparent" />
      <div className="pointer-events-none absolute inset-y-0 right-0 -z-10 w-48 bg-linear-to-l from-surface-deep to-transparent" />
