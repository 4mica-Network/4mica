    ...
    <div className="relative min-h-screen text-ink-body">
      <div className="relative z-10">
        ...
        <div className="w-full pb-20">
          ...
          <div className="mb-20 grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div className="glass-panel rounded-md p-8">
              <h2 className="mb-6 flex items-center font-bold text-3xl text-ink-strong">
                <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-md bg-red-500">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-center text-ink-body">
                      <div className="mr-3 h-2 w-2 rounded-md bg-red-500"></div>
                      {item}
                    </li>
                  ))}
                </ul>

                <div className="mt-6 rounded-md border border-red-400/30 bg-red-500/15 p-4">
              ...
              <div className="space-y-4">
                <ul className="space-y-5">
                  <li className="flex items-start text-ink-body text-lg">
                    <div className="mt-2 mr-3 h-3 w-3 rounded-md bg-brand-strong"></div>
          ...
          {/* 4Mica Solution */}
          <div className="glass-panel mb-20 rounded-md p-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-md border border-white/10 bg-white/10 p-6 text-center"
                >
                  <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-md bg-green-500">
          ...
          <div className="glass-panel mb-12 rounded-md p-8">
            <h2 className="mb-8 flex items-center justify-center text-center font-bold text-3xl text-ink-strong">
              <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-md bg-brand-deep">
                <div className="flex h-4 w-4 items-center justify-center">
            ...
            <div className="mb-8 flex flex-col items-center justify-center space-y-8 lg:flex-row lg:space-x-8 lg:space-y-0">
              <div className="flex flex-col items-center space-y-4 lg:flex-row lg:space-x-6 lg:space-y-0">
                <div className="min-w-[160px] rounded-md border border-white/10 bg-white/10 p-6 text-center">
                  <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-md bg-brand-deep">
                    <div className="flex h-6 w-6 items-center justify-center">
                ...
                <div className="min-w-[160px] rounded-md border border-white/10 bg-white/10 p-6 text-center">
                  <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-md bg-brand-strong">
                    <div className="flex h-6 w-6 items-center justify-center">
                ...
                <div className="min-w-[160px] rounded-md border border-white/10 bg-white/10 p-6 text-center">
                  <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-md bg-brand-violet">
                    <div className="flex h-6 w-6 items-center justify-center">
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="rounded-md border border-white/10 bg-white/10 p-4 text-center">
                <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-md bg-brand-strong">
                  <div className="flex h-4 w-4 items-center justify-center">
              ...
              <div className="rounded-md border border-white/10 bg-white/10 p-4 text-center">
                <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-md bg-brand-violet">
                  <div className="flex h-4 w-4 items-center justify-center">
              ...
              <div className="rounded-md border border-white/10 bg-white/10 p-4 text-center">
                <div className="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-md bg-brand-deep">
                  <div className="flex h-4 w-4 items-center justify-center">
