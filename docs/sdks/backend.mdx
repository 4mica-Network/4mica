...
Use <code>@4mica/x402</code> for Express middleware and server-side 4Mica x402 support. It wires protected routes, tab handling, facilitator calls, and scheme registration.
