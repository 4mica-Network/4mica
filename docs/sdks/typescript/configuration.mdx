...
| `network`              | No                               | Network shorthand or CAIP-2 id. Defaults to `base-sepolia`.             |
...
# 4MICA_RPC_URL="https://staging.api.4mica.io/"
4MICA_ETHEREUM_HTTP_RPC_URL="http://localhost:8545"
4MICA_CONTRACT_ADDRESS="0x..."
4MICA_FACILITATOR_URL="https://staging.facilitator.4mica.io"
4MICA_BEARER_TOKEN="Bearer <access_token>"
4MICA_AUTH_URL="https://staging.api.4mica.io/"
...
const cfg = new ConfigBuilder()
  .walletPrivateKey("0x...")
  .rpcUrl("https://staging.api.4mica.io/")
  .build();
