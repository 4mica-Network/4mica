...
4Mica's approach is to deposit collateral once, sign payment guarantees as requests happen, and settle the tab later instead of sending an on-chain transaction for every paid request. To start, you need:
