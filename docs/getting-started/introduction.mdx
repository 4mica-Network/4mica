...
<Steps>
  ...
  <Step title="Protect a Route">
    ...
    advertises a tab endpoint.
  </Step>
  <Step title="Sign a Guarantee">
    The buyer receives HTTP 402, opens or reuses a payment tab, signs a
    guarantee, and retries the request.
  </Step>
  ...
  <Step title="Close the Tab">
    The payer settles the tab after the credit window, or the seller claims from
    collateral during the on-chain claim window if the payer defaults.
  </Step>
</Steps>
