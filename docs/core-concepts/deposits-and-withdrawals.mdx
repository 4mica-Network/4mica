...
4Mica can accept native ETH and deployment-configured ERC-20 assets.
...
| Network | Deposits and payment requirements use the same CAIP-2 network. |
...
- [Wallet](./wallet): signer and wallet responsibilities.
- [Collateral ratios](./collateral-ratios): how deposits translate into credit
  capacity.
- [Transaction lifecycle](./transaction-lifecycle): how guarantees lock and
  release collateral.
- [Settlements](./settlements): how payable obligations resolve.
- [Earning yield](./earning-yield): how supported collateral can remain
  productive.
- [Buyer go-live](/buyer/go-live): production controls for autonomous spending.
