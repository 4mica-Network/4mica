...
Launch when the agent can spend autonomously without becoming opaque. A production buyer should always be able to see what the agent paid for, why it paid, which policy allowed it, and what value came back.
