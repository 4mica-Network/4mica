...
<Steps>
  ...
  <Step title="Tabs accumulate obligations">
    Small payments collect into tabs so settlement can happen later according to protocol rules.
  </Step>
</Steps>
...
<Warning>
If every tiny call settles separately, fees can erase the revenue you just earned. Use tabs and deferred settlement for high-frequency routes.
</Warning>
...
| Batching | Obligations accumulate through tabs instead of settling one by one. |
| Minimums | Your minimum price covers cost, support, and downstream paid calls. |
| Alerts | You watch invalid payment spikes and missed claim windows. |
