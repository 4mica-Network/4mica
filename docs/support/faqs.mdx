...
Base Sepolia is live on the 2.0 protocol and is where development, demos and
pilots run today. Base still serves the previous protocol version until its
upgrade lands, and Ethereum Sepolia is kept for legacy x402 v1 integrations.
...
- Base Sepolia: `eip155:84532` (2.0, live)
- Base: `eip155:8453` (upgrade pending)
