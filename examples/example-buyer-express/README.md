...
| --- | --- | --- |
| `SELLER_URL` | `http://localhost:3000/premium` | Point at the seller. Must match the seller's host/port (e.g. if you started it with `PORT=4000`, use `SELLER_URL=http://localhost:4000/premium`). |
