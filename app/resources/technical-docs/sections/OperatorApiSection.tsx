...
const endpoints = [
  ...
  },
  {
    ...
    expects: 'No body.',
    returns: '{ public_key, contract_address, ethereum_http_rpc_url, eip712_name, eip712_version, chain_id, max_accepted_guarantee_version, accepted_guarantee_versions, active_guarantee_domain_separator, trusted_validation_registries, validation_hash_canonicalization_version }',
    examples: [
      {
        label: 'Response',
        language: 'json',
  ...
  },
  {
    ...
    expects: '{ user_address, recipient_address, erc20_token?, ttl?, guarantee_version }',
    returns: '{ id, user_address, recipient_address, erc20_token?, asset_address, guarantee_version, next_req_id }',
    examples: [
      {
        label: 'Request',
        language: 'json',
  ...
  },
  {
    ...
    expects: '{ claims: { version: "v1"| "v2", ... }, signature, scheme: "eip712" | "eip191" }',
  ...
  },
  {
    ...
    expects: 'Path param: recipient_address. Optional query: settlement_status (repeatable).',
    returns: 'TabInfo[]',
    examples: [
      {
        label: 'Response',
  ...
  },
  {
    ...
    expects: 'Header: Authorization: Bearer <access_token> (role admin). Body: { suspended: boolean }',
